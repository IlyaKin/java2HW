package ru.gb.jtwo.chat.library.common;
...
public class Library {
    ...
    public static final String AUTH_ACCEPT = "/Добро пожаловать";
    ...
    public static final String TYPE_BROADCAST = "/Присоединился пользователь";
